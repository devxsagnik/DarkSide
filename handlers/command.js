...
let table = new ascii("Commands".dim.green);
const functions = require("../functions")
table.setHeading("Command".yellow, "Load status".red);
console.log("Welcome to HANDLER SERVICE // By © Beat Box // Discord: Felix_PlaYz#1000".bold.green)
module.exports = (client) => {
    readdirSync("./commands/").forEach(dir => {
        ...
        for (let file of commands) {
            ...
            if (pull.name) {
                ...
                table.addRow(file.green, 'Ready'.cyan);
            } else {
                table.addRow(file.red, `error -> missing a cmd.name, or cmd.name is not a string.`.red);
                continue;
            }
    ...
    console.log("Logging into Bot User...".cyan);
}